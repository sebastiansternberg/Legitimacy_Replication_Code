...
gip_jan <- read_dta("GIP_W27_V1.dta")
...
Merge interesting covariates from gip core study to it:

```{r}

gip_core <- read_dta("gip_core16.dta")


length(unique(gip_nov$id_g))
length(unique(gip_core$id_g))
...
save(gip_merge, file = "gip_merge.Rda")
